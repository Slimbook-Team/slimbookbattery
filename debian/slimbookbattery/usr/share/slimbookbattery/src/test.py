...
def change_icon(mode):
    indicator.set_icon_full(mode, 'Icon energy saving')
    

def graphic_settings():
    child = subprocess.Popen(('pkexec slimbookbattery-pkexec apply graphics').split(' '))
